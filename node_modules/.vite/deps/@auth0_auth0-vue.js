...
var j = async (e, t, i, o, n, a2, s2 = 1e4) => n ? (async (e2, t2, i2, o2, n2, a3, s3) => {
...
async function O(e, t) {
  ...
  return await async function(e2, t2, i2, o2, n2, a3, r3) {
    ...
    for (let s2 = 0; s2 < 3; s2++)
      try {
        c3 = await j(e2, i2, o2, n2, a3, r3, t2), l3 = null;
        break;
      } catch (e3) {
        l3 = e3;
      }
...
var ae = class {
  ...
  install(e) {
    this._client = new ee(Object.assign(Object.assign({}, this.clientOptions), { auth0Client: { name: "auth0-vue", version: "2.1.0" } })), this.__checkSession(e.config.globalProperties.$router), e.config.globalProperties.$auth0 = this, e.provide(a, this), ne.value = this;
  }
  async loginWithRedirect(e) {
