        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav d-none d-md-block ">
            <li v-if="!isAuthenticated && !isLoading" class="nav-item ">
                ...
                <button
                  id="qsLoginBtn"
                  class="btn btn-danger btn-margin mr-3"
                  @click.prevent="login"
                >Login</button>
                <button
                    id="qsPasswordLessLoginBtn"
                    class="btn btn-danger btn-margin mr-3"
                    @click.prevent="loginPasswordLess"
          ...
          <ul class="navbar-nav d-md-none " v-if="!isAuthenticated && !isLoading">
              <button id="qsLoginBtn" class="btn btn-danger btn-block" @click="login">Log in</button>
              <button id="qsPasswordLessLoginBtn" class="btn btn-danger btn-block" @click="loginPasswordLess">PasswordLess Log in</button>
          </ul>
